...
export default function ForgotPassword() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Using the new direct reset endpoint
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/auth/direct-reset-password`, {
                method: 'POST',
            ...
            setError('Failed to create to server')
        } finally {
            setIsLoading(false)
        }
    }
